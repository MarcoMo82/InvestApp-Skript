...
_SECTIONS: dict[str, list[str]] = {
    ...
    "risk": [
        ...
        "atr_period", "atr_sl_multiplier", "atr_tp_multiplier", "trailing_stop_atr_multiplier",
        "min_confidence_score", "max_sl_pct", "max_exposure_pct",
        "forex_max_sl_pips", "stock_max_sl_pct", "swing_sl_buffer_pct",
    ...
    "smc": [
        "fvg_enabled", "fvg_confidence_bonus", "fvg_min_size_pct",
        "ob_enabled", "ob_confidence_bonus", "ob_tolerance_pips",
        "ob_impulse_atr_multiplier", "level_dedup_threshold_pct",
    ...
    "entry": [
        "wick_body_ratio_min", "volume_confirmation_multiplier", "pullback_max_fib",
        "stop_hunt_sweep_min_atr", "stop_hunt_sweep_max_atr",
        "bull_flag_confidence_bonus", "bear_flag_confidence_bonus", "triangle_confidence_bonus",
    ],
    "safe_haven": [
...
class Config:
    ...
    DEFAULTS: dict = {
        ...
        "forex_max_sl_pips": 80,
        "stock_max_sl_pct": 0.03,
        "swing_sl_buffer_pct": 0.0002,
        ...
        "compression_range_ratio": 0.6,
        "expansion_atr_multiplier": 1.5,
        # entry
        "wick_body_ratio_min": 2.0,
        "volume_confirmation_multiplier": 1.5,
        "pullback_max_fib": 0.618,
        "stop_hunt_sweep_min_atr": 0.1,
        "stop_hunt_sweep_max_atr": 0.5,
        "bull_flag_confidence_bonus": 5,
